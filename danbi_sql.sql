...
CREATE TABLE `member` (
  ...
  `intake_goal` int DEFAULT NULL,
  `cycle` int NOT NULL,
  `intake_once` int NOT NULL,
...
CREATE TABLE `record` (
  ...
  `actual_intake` int NOT NULL,
  `member_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_record_member1_idx` (`member_id`),
  CONSTRAINT `fk_record_member1` FOREIGN KEY (`member_id`) REFERENCES `member` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `stamp` (
  ...
  `member_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_stamp_member1_idx` (`member_id`),
  CONSTRAINT `fk_stamp_member1` FOREIGN KEY (`member_id`) REFERENCES `member` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-11-29 17:04:57
